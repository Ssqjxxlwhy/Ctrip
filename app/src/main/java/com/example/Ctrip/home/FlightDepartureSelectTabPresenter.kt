...
class FlightDepartureSelectTabPresenter(private val model: FlightDepartureSelectTabContract.Model) : FlightDepartureSelectTabContract.Presenter {

    private var view: FlightDepartureSelectTabContract.View? = null
    ...
    override fun attachView(view: FlightDepartureSelectTabContract.View) {
        this.view = view
    }
