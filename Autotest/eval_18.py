...
# 任务18：进入"机票"页面，选择出发地"北京"、目的地"深圳"、选择日期10月25日，得到航班列表
# 检查条件：type="flight_search", from="北京", to="深圳", date="2025-10-25"

def check_flight_search_bj_sz():
...
if __name__ == "__main__":
    print("true" if check_flight_search_bj_sz() else "false")
